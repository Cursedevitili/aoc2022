...
class Monkey:
    def __init__(self, starting_items: list[int], operation: callable, test: callable, limit_worry: bool):
...
def main():
    monkey0demo = Monkey([79, 98], lambda x: x * 19, monkey0demo_test, True)
    monkey1demo = Monkey([54, 65, 75, 74], lambda x: x + 6, monkey1demo_test, True)
    monkey2demo = Monkey([79, 60, 97], lambda x: x * x, monkey2demo_test, True)
    monkey3demo = Monkey([74], lambda x: x + 3, monkey3demo_test, True)
    demo_group = Monkeys([monkey0demo, monkey1demo, monkey2demo, monkey3demo])

    monkey0demoWorry = Monkey([79, 98], lambda x: x * 19, monkey0demo_test, False)
    monkey1demoWorry = Monkey([54, 65, 75, 74], lambda x: x + 6, monkey1demo_test, False)
    monkey2demoWorry = Monkey([79, 60, 97], lambda x: x * x, monkey2demo_test, False)
    monkey3demoWorry = Monkey([74], lambda x: x + 3, monkey3demo_test, False)
    demo_groupWorry = Monkeys([monkey0demoWorry, monkey1demoWorry, monkey2demoWorry, monkey3demoWorry])

    # monkey0 = Monkey([66, 71, 94], lambda x: x * 5, monkey0_test, True)
    # monkey1 = Monkey([70], lambda x: x + 6, monkey1_test, True)
    # monkey2 = Monkey([62, 68, 56, 65, 94, 78], lambda x: x + 5, monkey2_test, True)
    # monkey3 = Monkey([89, 94, 94, 67], lambda x: x + 2, monkey3_test, True)
    # monkey4 = Monkey([71, 61, 73, 65, 98, 98, 63], lambda x: x * 7, monkey4_test, True)
    # monkey5 = Monkey([55, 62, 68, 61, 60], lambda x: x + 7, monkey5_test, True)
    # monkey6 = Monkey([93, 91, 69, 64, 72, 89, 50, 71], lambda x: x + 1, monkey6_test, True)
    # monkey7 = Monkey([76, 50], lambda x: x * x, monkey7_test, True)
